...
public class TankAI : MonoBehaviour
{
    ...
    private void Start()
    {
        m_aiPath.maxSpeed = m_tankController.TracksController.tracks.Data.speed * Time.deltaTime * velocityRate;
        m_aiPath.maxAcceleration = m_tankController.TracksController.tracks.Data.speed * Time.deltaTime * velocityRate;
        m_aiPath.rotationSpeed = m_tankController.TracksController.tracks.Data.rotationSpeed * Time.deltaTime * 100 * velocityRate;
    ...
    private void FixedUpdate()
    {
        ...
        towerTransform.transform.rotation = Quaternion.Slerp(towerTransform.transform.rotation, q, Time.deltaTime * m_tankController.TowerController.tower.Data.rotationSpeed);
